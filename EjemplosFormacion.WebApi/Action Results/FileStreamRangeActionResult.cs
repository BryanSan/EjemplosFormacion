...
{
    /// <summary>
    /// Custom Action Result para devolver un archivo unico, como Partial Content usando la clase PushStreamContent como Content para Streaming
    ...
    /// </summary>
    class FileStreamRangeActionResult : IHttpActionResult
    {
        readonly Stream _stream;
        readonly string _contentType;
        readonly RangeHeaderValue _rangeHeader;

        public FileStreamRangeActionResult(Stream stream, string contentType, RangeHeaderValue rangeHeader)
        {
            if (string.IsNullOrWhiteSpace(contentType)) throw new ArgumentException("contentType vacio!.");
            if (_rangeHeader == null || !_rangeHeader.Ranges.Any()) throw new ArgumentException("rangeHeader Invalido o Vacio!.");
